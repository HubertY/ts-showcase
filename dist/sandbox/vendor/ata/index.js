 ...
 */
export const setupTypeAcquisition = (config, libIgnore = []) => {
    ...
    function resolveDeps(initialSourceFile, depth) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const depsToGet = deps.filter((dep) => libIgnore.indexOf(dep.module) === -1);
 ...
 */
export const getReferencesForModule = (ts, code) => {
...
export function getNewDependencies(config, moduleMap, code) {
    const refs = getReferencesForModule(config.typescript, code).map(ref => (Object.assign(Object.assign({}, ref), { module: mapModuleNameToModule(ref.module) })));
...
export const getFileTreeForModuleWithTag = (config, moduleName, tag) => __awaiter(void 0, void 0, void 0, function* () {
