 ...
 */
export function createVirtualTypeScriptEnvironment(sys, rootFiles, ts, compilerOptions = {}, customTransformers) {
 ...
 */
export const knownLibFilesForCompilerOptions = (compilerOptions, ts) => {
 ...
 */
export const createDefaultMapFromNodeModules = (_compilerOptions, _ts, tsLibDirectory) => {
 ...
 */
export const addAllFilesFromFolder = (map, workingDir) => {
    const path = requirePath();
    const fs = requireFS();
...
export const addFilesForTypesIntoFolder = (map) => addAllFilesFromFolder(map, "node_modules/@types");
/**
 ...
 */
export const createDefaultMapFromCDN = (options, version, cache, ts, lzstring, fetcher, storer) => {
 ...
 */
export function createSystem(files) {
    return {
        args: [],
 ...
 */
export function createFSBackedSystem(files, _projectRoot, ts, tsLibDirectory) {
 ...
 */
export function createVirtualCompilerHost(sys, compilerOptions, ts) {
 ...
 */
export function createVirtualLanguageServiceHost(sys, rootFiles, compilerOptions, ts, customTransformers) {
